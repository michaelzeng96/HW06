...
unsigned int lookupRank(unsigned year, string gender, string name)
{
	...
	{
	case 2001:
		file.open("babynameranking2001.txt", ios::in|ios::skipws);
		break;
	case 2002:
		file.open("babynameranking2002.txt", ios::in|ios::skipws);
		break;
	case 2003:
		file.open("babynameranking2003.txt", ios::in|ios::skipws);
		break;
	case 2004:
		file.open("babynameranking2004.txt", ios::in|ios::skipws);
		break;
	case 2005:
		file.open("babynameranking2005.txt", ios::in|ios::skipws);
		break;
	case 2006:
		file.open("babynameranking2006.txt", ios::in|ios::skipws);
		break;
	case 2007:
		file.open("babynameranking2007.txt", ios::in|ios::skipws);
		break;
	case 2008:
		file.open("babynameranking2008.txt", ios::in|ios::skipws);
		break;
	case 2009:
		file.open("babynameranking2009.txt", ios::in|ios::skipws);
		break;
	case 2010:
		file.open("babynameranking2010.txt", ios::in|ios::skipws);
		break;
	default:
